...
setup(
    ...
    install_requires=[
        'wheel', 'conllu', 'pytorch_pretrained_bert', 'jsonlines', 'docopt', 'more_itertools', 'stanfordnlp', 'nltk', 'pandas', 'networkx', 'spacy', 'tupa==1.4.2', 'ucca==1.2.3', 'requests', 'stanfordcorenlp', 'ijson'
    ]
)
