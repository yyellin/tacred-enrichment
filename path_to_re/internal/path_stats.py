...
class PathStats(object):
    ...
    def __init__(self, input_file):
        ...
        for row in train_data.itertuples():
            ...
            trigger_to_ent2 = PathStats.get_steps_as_string(graph.get_undirected_steps(trigger_index, ent2_head), pss_tags)
            trigger_to_ent1 = PathStats.get_steps_as_string(graph.get_undirected_steps(trigger_index, ent1_head), pss_tags)
            ent1_to_trigger = PathStats.get_steps_as_string(graph.get_undirected_steps(ent1_head, trigger_index), pss_tags)
            ent1_to_ent2_via_trigger = '{0} >< {1}'.format(ent1_to_trigger, trigger_to_ent2)
            ent1_to_ent2 = PathStats.get_steps_as_string(graph.get_undirected_steps(ent1_head, ent2_head), pss_tags)
